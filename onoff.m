function [im, on, off, rgcs, fltrs] = onoff(varargin)
%
...
%       image pixel
%
%       If the 'plotIt' argument is supplied and equals 1, it will plot
%       results, if it is not supplied or 0, it will not
%
%
...
[fname, appix,pl]   = handle_args(varargin{:});                 % handle the input args and load defaults
